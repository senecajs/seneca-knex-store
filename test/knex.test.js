...
describe('transaction', function () {
  ...
  //   const data = await s0.entity('foo').data$({p1:'t1'}).save$()
  //   console.log('data HAPPY', data)
  //   const tx0 = await s0.entity.end()
  //   console.log('tx0 HAPPY', tx0)
  ...
  it('rollback', async () => {
    ...
    expect(tx0).include({result: { done: false }})
...
function makeSenecaForTest(DbConfig, opts = {}) {
  ...
  console.log('entity_opts', entity_opts)
